...
public class LeaveApplicationController {
	...
	@RequestMapping(value = "/history")
	  public String leaveAppHistory(HttpSession session, Model model) {
	    ...
	    List<LeaveApplication> applicationList=laService.findAllLeaveApplications();
	    applicationList.removeIf(p -> p.getId()!=id);
	  ...
	  public String editLeaveApp(@ModelAttribute @Valid LeaveApplication leaveApplication, BindingResult result, @PathVariable Integer id,
	      HttpSession session) throws LeaveAppNotFound {
	    if (result.hasErrors())
	      return "leave-edit";
	  ...
	  public String deleteLeaveApp(@PathVariable Integer id) throws LeaveAppNotFound {
